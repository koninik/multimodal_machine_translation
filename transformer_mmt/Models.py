...
from transformer_mmt.Layers import EncoderLayer, DecoderLayer
...
class Encoder(nn.Module):
    ...
    def forward(self, src_seq, src_pos, return_attns=False):
        ...
        #We want to make the image features --> [batch_size, src_seq, d_model] from [29000, 2048]
...
class Transformer(nn.Module):
    ...
    def forward(self, src_seq, src_pos, tgt_seq, tgt_pos, image_features):
