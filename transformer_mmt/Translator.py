...
from transformer_mmt.Beam import Beam
...
class Translator(object):
    ...
    def translate_batch(self, src_seq, src_pos, image_features): 
        ...
        def collate_active_info(
            ...
            return active_src_seq, active_src_enc, active_inst_idx_to_position_map, active_image_features

        def beam_decode_step(
                inst_dec_beams, len_dec_seq, src_seq, enc_output, image_features, inst_idx_to_position_map, n_bm):
        ...
        with torch.no_grad():
            ...
            for len_dec_seq in range(1, self.model_opt.max_token_seq_len + 1):
                ...
                active_inst_idx_list = beam_decode_step(
                    inst_dec_beams, len_dec_seq, src_seq, src_enc, image_features, inst_idx_to_position_map, n_bm)
